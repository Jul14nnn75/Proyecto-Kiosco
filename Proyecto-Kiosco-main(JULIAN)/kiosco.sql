...
#ESTO ES DE PRUEBA DESPUES SE MODIFICA
ALTER TABLE empleado ADD COLUMN nombre VARCHAR(50);
INSERT INTO usuario (id_usuario, nombre, contraseña)
VALUES (1, 'ana_gomez', 'clave123');
INSERT INTO empleado (id_usuario, rol, dni, nombre)
VALUES (1, 'Cajera', '12345678', 'Ana');

ALTER TABLE turno_empleado
CHANGE COLUMN fecha dia VARCHAR(20);
